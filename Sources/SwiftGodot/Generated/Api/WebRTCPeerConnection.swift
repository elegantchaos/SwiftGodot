...
open class WebRTCPeerConnection: RefCounted {
    ...
    /// }
    /// ```
    public var sessionDescriptionCreated: GenericSignal<String, String> { GenericSignal<String, String> (target: self, signalName: "session_description_created") }
    ...
    /// }
    /// ```
    public var iceCandidateCreated: GenericSignal<String, Int64, String> { GenericSignal<String, Int64, String> (target: self, signalName: "ice_candidate_created") }
    ...
    /// }
    /// ```
    public var dataChannelReceived: GenericSignal<WebRTCDataChannel> { GenericSignal<WebRTCDataChannel> (target: self, signalName: "data_channel_received") }
