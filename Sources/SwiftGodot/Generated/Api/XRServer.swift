...
open class XRServer: Object {
    ...
    /// }
    /// ```
    public var referenceFrameChanged: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "reference_frame_changed") }
    ...
    /// }
    /// ```
    public var trackerAdded: GenericSignal<StringName, Int64> { GenericSignal<StringName, Int64> (target: self, signalName: "tracker_added") }
    ...
    /// }
    /// ```
    public var trackerUpdated: GenericSignal<StringName, Int64> { GenericSignal<StringName, Int64> (target: self, signalName: "tracker_updated") }
    ...
    /// }
    /// ```
    public var trackerRemoved: GenericSignal<StringName, Int64> { GenericSignal<StringName, Int64> (target: self, signalName: "tracker_removed") }
