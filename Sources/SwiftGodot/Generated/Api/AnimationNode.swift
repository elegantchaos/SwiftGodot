...
open class AnimationNode: Resource {
    ...
    /// }
    /// ```
    public var animationNodeRenamed: GenericSignal<Int64, String, String> { GenericSignal<Int64, String, String> (target: self, signalName: "animation_node_renamed") }
    ...
    /// }
    /// ```
    public var animationNodeRemoved: GenericSignal<Int64, String> { GenericSignal<Int64, String> (target: self, signalName: "animation_node_removed") }
