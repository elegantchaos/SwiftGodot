...
open class RigidBody3D: PhysicsBody3D {
    ...
    /// }
    /// ```
    public var bodyShapeEntered: GenericSignal<RID, Node, Int64, Int64> { GenericSignal<RID, Node, Int64, Int64> (target: self, signalName: "body_shape_entered") }
    ...
    /// }
    /// ```
    public var bodyShapeExited: GenericSignal<RID, Node, Int64, Int64> { GenericSignal<RID, Node, Int64, Int64> (target: self, signalName: "body_shape_exited") }
    ...
    /// }
    /// ```
    public var bodyEntered: GenericSignal<Node> { GenericSignal<Node> (target: self, signalName: "body_entered") }
    ...
    /// }
    /// ```
    public var bodyExited: GenericSignal<Node> { GenericSignal<Node> (target: self, signalName: "body_exited") }
    ...
    /// }
    /// ```
    public var sleepingStateChanged: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "sleeping_state_changed") }
