...
open class GraphEdit: Control {
    ...
    /// }
    /// ```
    public var connectionRequest: GenericSignal<StringName, Int64, StringName, Int64> { GenericSignal<StringName, Int64, StringName, Int64> (target: self, signalName: "connection_request") }
    ...
    /// }
    /// ```
    public var disconnectionRequest: GenericSignal<StringName, Int64, StringName, Int64> { GenericSignal<StringName, Int64, StringName, Int64> (target: self, signalName: "disconnection_request") }
    ...
    /// }
    /// ```
    public var connectionToEmpty: GenericSignal<StringName, Int64, Vector2> { GenericSignal<StringName, Int64, Vector2> (target: self, signalName: "connection_to_empty") }
    ...
    /// }
    /// ```
    public var connectionFromEmpty: GenericSignal<StringName, Int64, Vector2> { GenericSignal<StringName, Int64, Vector2> (target: self, signalName: "connection_from_empty") }
    ...
    /// }
    /// ```
    public var connectionDragStarted: GenericSignal<StringName, Int64, Bool> { GenericSignal<StringName, Int64, Bool> (target: self, signalName: "connection_drag_started") }
    ...
    /// }
    /// ```
    public var connectionDragEnded: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "connection_drag_ended") }
    ...
    /// }
    /// ```
    public var copyNodesRequest: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "copy_nodes_request") }
    ...
    /// }
    /// ```
    public var pasteNodesRequest: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "paste_nodes_request") }
    ...
    /// }
    /// ```
    public var duplicateNodesRequest: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "duplicate_nodes_request") }
    ...
    /// }
    /// ```
    public var deleteNodesRequest: GenericSignal<VariantCollection<StringName>> { GenericSignal<VariantCollection<StringName>> (target: self, signalName: "delete_nodes_request") }
    ...
    /// }
    /// ```
    public var nodeSelected: GenericSignal<Node> { GenericSignal<Node> (target: self, signalName: "node_selected") }
    ...
    /// }
    /// ```
    public var nodeDeselected: GenericSignal<Node> { GenericSignal<Node> (target: self, signalName: "node_deselected") }
    ...
    /// }
    /// ```
    public var frameRectChanged: GenericSignal<GraphFrame, Vector2> { GenericSignal<GraphFrame, Vector2> (target: self, signalName: "frame_rect_changed") }
    ...
    /// }
    /// ```
    public var popupRequest: GenericSignal<Vector2> { GenericSignal<Vector2> (target: self, signalName: "popup_request") }
    ...
    /// }
    /// ```
    public var beginNodeMove: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "begin_node_move") }
    ...
    /// }
    /// ```
    public var endNodeMove: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "end_node_move") }
    ...
    /// }
    /// ```
    public var graphElementsLinkedToFrameRequest: GenericSignal<GArray, StringName> { GenericSignal<GArray, StringName> (target: self, signalName: "graph_elements_linked_to_frame_request") }
    ...
    /// }
    /// ```
    public var scrollOffsetChanged: GenericSignal<Vector2> { GenericSignal<Vector2> (target: self, signalName: "scroll_offset_changed") }
