...
open class CameraServer: Object {
    ...
    /// }
    /// ```
    public var cameraFeedAdded: GenericSignal<Int64> { GenericSignal<Int64> (target: self, signalName: "camera_feed_added") }
    ...
    /// }
    /// ```
    public var cameraFeedRemoved: GenericSignal<Int64> { GenericSignal<Int64> (target: self, signalName: "camera_feed_removed") }
