...
open class CodeEdit: TextEdit {
    ...
    /// }
    /// ```
    public var breakpointToggled: GenericSignal<Int64> { GenericSignal<Int64> (target: self, signalName: "breakpoint_toggled") }
    ...
    /// }
    /// ```
    public var codeCompletionRequested: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "code_completion_requested") }
    ...
    /// }
    /// ```
    public var symbolLookup: GenericSignal<String, Int64, Int64> { GenericSignal<String, Int64, Int64> (target: self, signalName: "symbol_lookup") }
    ...
    /// }
    /// ```
    public var symbolValidate: GenericSignal<String> { GenericSignal<String> (target: self, signalName: "symbol_validate") }
