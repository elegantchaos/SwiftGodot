...
open class SceneMultiplayer: MultiplayerAPI {
    ...
    /// }
    /// ```
    public var peerAuthenticating: GenericSignal<Int64> { GenericSignal<Int64> (target: self, signalName: "peer_authenticating") }
    ...
    /// }
    /// ```
    public var peerAuthenticationFailed: GenericSignal<Int64> { GenericSignal<Int64> (target: self, signalName: "peer_authentication_failed") }
    ...
    /// }
    /// ```
    public var peerPacket: GenericSignal<Int64, PackedByteArray> { GenericSignal<Int64, PackedByteArray> (target: self, signalName: "peer_packet") }
