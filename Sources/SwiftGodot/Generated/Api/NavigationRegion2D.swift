...
open class NavigationRegion2D: Node2D {
    ...
    /// }
    /// ```
    public var navigationPolygonChanged: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "navigation_polygon_changed") }
    ...
    /// }
    /// ```
    public var bakeFinished: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "bake_finished") }
