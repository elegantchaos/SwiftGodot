...
open class CollisionObject2D: Node2D {
    ...
    /// }
    /// ```
    public var inputEvent: GenericSignal<Node, InputEvent, Int64> { GenericSignal<Node, InputEvent, Int64> (target: self, signalName: "input_event") }
    ...
    /// }
    /// ```
    public var mouseShapeEntered: GenericSignal<Int64> { GenericSignal<Int64> (target: self, signalName: "mouse_shape_entered") }
    ...
    /// }
    /// ```
    public var mouseShapeExited: GenericSignal<Int64> { GenericSignal<Int64> (target: self, signalName: "mouse_shape_exited") }
