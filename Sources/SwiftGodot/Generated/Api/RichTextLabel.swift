...
open class RichTextLabel: Control {
    ...
    /// }
    /// ```
    public var metaClicked: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "meta_clicked") }
    ...
    /// }
    /// ```
    public var metaHoverStarted: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "meta_hover_started") }
    ...
    /// }
    /// ```
    public var metaHoverEnded: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "meta_hover_ended") }
