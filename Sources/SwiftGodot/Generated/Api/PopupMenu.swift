...
open class PopupMenu: Popup {
    ...
    /// }
    /// ```
    public var idPressed: GenericSignal<Int64> { GenericSignal<Int64> (target: self, signalName: "id_pressed") }
    ...
    /// }
    /// ```
    public var idFocused: GenericSignal<Int64> { GenericSignal<Int64> (target: self, signalName: "id_focused") }
    ...
    /// }
    /// ```
    public var indexPressed: GenericSignal<Int64> { GenericSignal<Int64> (target: self, signalName: "index_pressed") }
    ...
    /// }
    /// ```
    public var menuChanged: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "menu_changed") }
