...
open class BoneMap: Resource {
    ...
    /// }
    /// ```
    public var boneMapUpdated: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "bone_map_updated") }
    ...
    /// }
    /// ```
    public var profileUpdated: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "profile_updated") }
