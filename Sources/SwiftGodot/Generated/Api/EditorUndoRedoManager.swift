...
open class EditorUndoRedoManager: Object {
    ...
    /// }
    /// ```
    public var historyChanged: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "history_changed") }
    ...
    /// }
    /// ```
    public var versionChanged: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "version_changed") }
