...
open class AnimationPlayer: AnimationMixer {
    ...
    /// }
    /// ```
    public var currentAnimationChanged: GenericSignal<String> { GenericSignal<String> (target: self, signalName: "current_animation_changed") }
    ...
    /// }
    /// ```
    public var animationChanged: GenericSignal<StringName, StringName> { GenericSignal<StringName, StringName> (target: self, signalName: "animation_changed") }
