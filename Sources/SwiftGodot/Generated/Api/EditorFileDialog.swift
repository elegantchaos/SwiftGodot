...
open class EditorFileDialog: ConfirmationDialog {
    ...
    /// }
    /// ```
    public var fileSelected: GenericSignal<String> { GenericSignal<String> (target: self, signalName: "file_selected") }
    ...
    /// }
    /// ```
    public var filesSelected: GenericSignal<PackedStringArray> { GenericSignal<PackedStringArray> (target: self, signalName: "files_selected") }
    ...
    /// }
    /// ```
    public var dirSelected: GenericSignal<String> { GenericSignal<String> (target: self, signalName: "dir_selected") }
