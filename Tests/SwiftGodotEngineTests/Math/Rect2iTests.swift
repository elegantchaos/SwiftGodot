...
final class Rect2iTests: GodotTestCase {
    ...
    func testIntersection() {
        XCTAssertEqual(
            Rect2i(x: 0, y: 100, width: 1280, height: 720).intersection(b: Rect2i(x: 0, y: 300, width: 100, height: 100)), Rect2i(x: 0, y: 300, width: 100, height: 100),
        ...
        XCTAssertEqual(
            Rect2i(x: 0, y: 100, width: 1280, height: 720).intersection(b: Rect2i(x: 1200, y: 700, width: 100, height: 100)), Rect2i(x: 1200, y: 700, width: 80, height: 100),
            "intersection() with partially enclosed Rect2i should return the expected result.")
        XCTAssertEqual(
            Rect2i(x: 0, y: 100, width: 1280, height: 720).intersection(b: Rect2i(x: -4000, y: -4000, width: 100, height: 100)), Rect2i(),
            "intersection() with non-enclosed Rect2i should return the expected result.")
    }

    func testEnclosing() {
        XCTAssertTrue(
            Rect2i(x: 0, y: 100, width: 1280, height: 720).encloses(b: Rect2i(x: 0, y: 300, width: 100, height: 100)), "encloses() with fully contained Rect2i should return the expected result.")
        XCTAssertTrue(
            !Rect2i(x: 0, y: 100, width: 1280, height: 720).encloses(b: Rect2i(x: 1200, y: 700, width: 100, height: 100)),
            "encloses() with partially contained Rect2i should return the expected result.")
        XCTAssertTrue(
            !Rect2i(x: 0, y: 100, width: 1280, height: 720).encloses(b: Rect2i(x: -4000, y: -4000, width: 100, height: 100)), "encloses() with non-contained Rect2i should return the expected result.")
    ...
    func testExpanding() {
        XCTAssertEqual(
            Rect2i(x: 0, y: 100, width: 1280, height: 720).expand(to: Vector2i(x: 500, y: 600)), Rect2i(x: 0, y: 100, width: 1280, height: 720),
            "expand() with contained Vector2i should return the expected result.")
        XCTAssertEqual(
            Rect2i(x: 0, y: 100, width: 1280, height: 720).expand(to: Vector2i(x: 0, y: 0)), Rect2i(x: 0, y: 0, width: 1280, height: 820),
            "expand() with non-contained Vector2i should return the expected result.")
    }

    func testGrowing() {
        XCTAssertEqual(
            Rect2i(x: 0, y: 100, width: 1280, height: 720).grow(amount: 100), Rect2i(x: -100, y: 0, width: 1480, height: 920), "grow() with positive value should return the expected Rect2i.")
        XCTAssertEqual(
            Rect2i(x: 0, y: 100, width: 1280, height: 720).grow(amount: -100), Rect2i(x: 100, y: 200, width: 1080, height: 520), "grow() with negative value should return the expected Rect2i.")
        XCTAssertEqual(
            Rect2i(x: 0, y: 100, width: 1280, height: 720).grow(amount: -4000), Rect2i(x: 4000, y: 4100, width: -6720, height: -7280),
            "grow() with large negative value should return the expected Rect2i.")

        XCTAssertEqual(
            Rect2i(x: 0, y: 100, width: 1280, height: 720).growIndividual(left: 100, top: 200, right: 300, bottom: 400), Rect2i(x: -100, y: -100, width: 1680, height: 1320),
            "growIndividual() with positive values should return the expected Rect2i.")
        XCTAssertEqual(
            Rect2i(x: 0, y: 100, width: 1280, height: 720).growIndividual(left: -100, top: 200, right: 300, bottom: -400), Rect2i(x: 100, y: -100, width: 1480, height: 520),
            "growIndividual() with positive and negative values should return the expected Rect2i.")

        XCTAssertEqual(
            Rect2i(x: 0, y: 100, width: 1280, height: 720).growSide(Side.top.rawValue, amount: 500), Rect2i(x: 0, y: -400, width: 1280, height: 1220),
            "growSide() with positive value should return the expected Rect2i.")
        XCTAssertEqual(
            Rect2i(x: 0, y: 100, width: 1280, height: 720).growSide(Side.top.rawValue, amount: -500), Rect2i(x: 0, y: 600, width: 1280, height: 220),
            "growSide() with negative value should return the expected Rect2i.")
    }
    ...
    func testIntersects() {
        XCTAssertTrue(
            Rect2i(x: 0, y: 100, width: 1280, height: 720).intersects(b: Rect2i(x: 0, y: 300, width: 100, height: 100)), "intersects() with fully enclosed Rect2i should return the expected result.")
        XCTAssertTrue(
            Rect2i(x: 0, y: 100, width: 1280, height: 720).intersects(b: Rect2i(x: 1200, y: 700, width: 100, height: 100)),
            "intersects() with partially enclosed Rect2i should return the expected result.")
        XCTAssertTrue(
            !Rect2i(x: 0, y: 100, width: 1280, height: 720).intersects(b: Rect2i(x: -4000, y: -4000, width: 100, height: 100)),
    ...
    func testMerging() {
        XCTAssertEqual(
            Rect2i(x: 0, y: 100, width: 1280, height: 720).merge(b: Rect2i(x: 0, y: 300, width: 100, height: 100)), Rect2i(x: 0, y: 100, width: 1280, height: 720),
            "merge() with fully enclosed Rect2i should return the expected result.")
        XCTAssertEqual(
            Rect2i(x: 0, y: 100, width: 1280, height: 720).merge(b: Rect2i(x: 1200, y: 700, width: 100, height: 100)), Rect2i(x: 0, y: 100, width: 1300, height: 720),
            "merge() with partially enclosed Rect2i should return the expected result.")
        XCTAssertEqual(
            Rect2i(x: 0, y: 100, width: 1280, height: 720).merge(b: Rect2i(x: -4000, y: -4000, width: 100, height: 100)), Rect2i(x: -4000, y: -4000, width: 5280, height: 4820),
