...
final class Geometry2DTests: GodotTestCase {
    ...
    func testSegmentIntersectionWithCircle() {
        ...
        XCTAssertEqual(
            Geometry2D.segmentIntersectsCircle(segmentFrom: Vector2(x: 0, y: 0), segmentTo: Vector2(x: 4, y: 0), circlePosition: Vector2(x: 0, y: 0), circleRadius: 1.0), oneQuarter,
            "Segment from inside to outside of circle should intersect it.")
        XCTAssertEqual(
            Geometry2D.segmentIntersectsCircle(segmentFrom: Vector2(x: 4, y: 0), segmentTo: Vector2(x: 0, y: 0), circlePosition: Vector2(x: 0, y: 0), circleRadius: 1.0), threeQuarters,
            "Segment from outside to inside of circle should intersect it.")

        XCTAssertEqual(
            Geometry2D.segmentIntersectsCircle(segmentFrom: Vector2(x: -2, y: 0), segmentTo: Vector2(x: 2, y: 0), circlePosition: Vector2(x: 0, y: 0), circleRadius: 1.0), oneQuarter,
        ...
        XCTAssertEqual(
            Geometry2D.segmentIntersectsCircle(segmentFrom: Vector2(x: 0, y: 0), segmentTo: Vector2(x: 1, y: 0), circlePosition: Vector2(x: 0, y: 0), circleRadius: 1.0), one,
            "Segment starting inside the circle and ending on the circle should intersect it")
        XCTAssertEqual(
            Geometry2D.segmentIntersectsCircle(segmentFrom: Vector2(x: 1, y: 0), segmentTo: Vector2(x: 0, y: 0), circlePosition: Vector2(x: 0, y: 0), circleRadius: 1.0), zero,
            "Segment starting on the circle and going inwards should intersect it")
        XCTAssertEqual(
            Geometry2D.segmentIntersectsCircle(segmentFrom: Vector2(x: 1, y: 0), segmentTo: Vector2(x: 2, y: 0), circlePosition: Vector2(x: 0, y: 0), circleRadius: 1.0), zero,
            "Segment starting on the circle and going outwards should intersect it")
        XCTAssertEqual(
            Geometry2D.segmentIntersectsCircle(segmentFrom: Vector2(x: 2, y: 0), segmentTo: Vector2(x: 1, y: 0), circlePosition: Vector2(x: 0, y: 0), circleRadius: 1.0), one,
            "Segment starting outside the circle and ending on the circle intersect it")

        XCTAssertEqual(
            Geometry2D.segmentIntersectsCircle(segmentFrom: Vector2(x: -1, y: 0), segmentTo: Vector2(x: 1, y: 0), circlePosition: Vector2(x: 0, y: 0), circleRadius: 2.0), minusOne,
            "Segment completely within the circle should not intersect it")
        XCTAssertEqual(
            Geometry2D.segmentIntersectsCircle(segmentFrom: Vector2(x: 1, y: 0), segmentTo: Vector2(x: -1, y: 0), circlePosition: Vector2(x: 0, y: 0), circleRadius: 2.0), minusOne,
            "Segment completely within the circle should not intersect it")
        XCTAssertEqual(
            Geometry2D.segmentIntersectsCircle(segmentFrom: Vector2(x: 2, y: 0), segmentTo: Vector2(x: 3, y: 0), circlePosition: Vector2(x: 0, y: 0), circleRadius: 1.0), minusOne,
            "Segment completely outside the circle should not intersect it")
        XCTAssertEqual(
            Geometry2D.segmentIntersectsCircle(segmentFrom: Vector2(x: 3, y: 0), segmentTo: Vector2(x: 2, y: 0), circlePosition: Vector2(x: 0, y: 0), circleRadius: 1.0), minusOne,
            "Segment completely outside the circle should not intersect it")
    }
    ...
    func testClosestPointToSegment() {
        ...
        XCTAssertEqual(
            Geometry2D.getClosestPointToSegment(point: Vector2(x: -3, y: 4), s1: Vector2(x: 1, y: -2), s2: Vector2(x: 1, y: -2)), Vector2(x: 1, y: -2),
