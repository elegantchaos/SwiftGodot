...
final class Vector4Tests: GodotTestCase {
    ...
    func testInterpolationMethods() {
        ...
        XCTAssertEqual(
            vector1.cubicInterpolate(b: vector2, preA: Vector4(), postB: Vector4(x: 7, y: 7, z: 7, w: 7), weight: 0.5), Vector4(x: 2.375, y: 3.5, z: 4.625, w: 5.75),
            "Vector4 cubicInterpolate should work as expected.")
        assertApproxEqual(
            vector1.cubicInterpolate(b: vector2, preA: Vector4(), postB: Vector4(x: 7, y: 7, z: 7, w: 7), weight: 1.0 / 3.0),
            Vector4(x: 1.851851940155029297, y: 2.962963104248046875, z: 4.074074268341064453, w: 5.185185185185), "Vector4 cubicInterpolate should work as expected.")
    }
    ...
    func testOperators() {
        ...
        XCTAssertEqual(
            Variant(Vector4(x: Float.e, y: Float.sqrt2, z: Float.sqrt3, w: Float.sqrt3)).description, "(2.718282, 1.414214, 1.732051, 1.732051)",
            "Vector4 cast to String should print the correct amount of digits for realT = float.")
    }
