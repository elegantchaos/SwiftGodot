...
final class Rect2Tests: GodotTestCase {
    ...
    func testEnclosing() {
        XCTAssertTrue(
            Rect2(x: 0, y: 100, width: 1280, height: 720).encloses(b: Rect2(x: 0, y: 300, width: 100, height: 100)), "encloses() with fully contained Rect2 should return the expected result.")
        XCTAssertTrue(
            !Rect2(x: 0, y: 100, width: 1280, height: 720).encloses(b: Rect2(x: 1200, y: 700, width: 100, height: 100)), "encloses() with partially contained Rect2 should return the expected result.")
        XCTAssertTrue(
            !Rect2(x: 0, y: 100, width: 1280, height: 720).encloses(b: Rect2(x: -4000, y: -4000, width: 100, height: 100)), "encloses() with non-contained Rect2 should return the expected result.")
    }
    ...
    func testIntersects() {
        XCTAssertTrue(
            Rect2(x: 0, y: 100, width: 1280, height: 720).intersects(b: Rect2(x: 0, y: 300, width: 100, height: 100)), "intersects() with fully enclosed Rect2 should return the expected result.")
        XCTAssertTrue(
            Rect2(x: 0, y: 100, width: 1280, height: 720).intersects(b: Rect2(x: 1200, y: 700, width: 100, height: 100)),
            "intersects() with partially enclosed Rect2 should return the expected result.")
        XCTAssertTrue(
            !Rect2(x: 0, y: 100, width: 1280, height: 720).intersects(b: Rect2(x: -4000, y: -4000, width: 100, height: 100)), "intersects() with non-enclosed Rect2 should return the expected result.")
    }
