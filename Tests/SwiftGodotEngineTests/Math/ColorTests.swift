...
final class ColorTests: GodotTestCase {
    ...
    func testConstructorMethods() {
        ...
        let blueHex: Color = Color.hex(hex: 0x4060_ff80)
    ...
    func testConversionMethods() {
        ...
        XCTAssertEqual(cyan.toArgb32(), 0xff00_ffff, "The returned 32-bit RGB number should match the expected value.")
        XCTAssertEqual(cyan.toAbgr32(), 0xffff_ff00, "The returned 32-bit BGR number should match the expected value.")
        XCTAssertEqual(cyan.toRgba32(), 0x00ff_ffff, "The returned 32-bit BGR number should match the expected value.")
    ...
    func testNamedColors() {
        XCTAssertEqual(Color(code: "red"), Color.hex(hex: 0xFF00_00FF), "The named color \"red\" should match the expected value.")

        // Named colors have their names automatically normalized.
        XCTAssertEqual(Color(code: "whiteSmoke"), Color.hex(hex: 0xF5F5_F5FF), "The named color \"whiteSmoke\" should match the expected value.")
        XCTAssertEqual(Color(code: "Slate Blue"), Color.hex(hex: 0x6A5A_CDFF), "The named color \"Slate Blue\" should match the expected value.")
