...
final class MarshalTests: GodotTestCase {
    ...
    func testVarargMethodsPerformance() {
        ...
        measure {
            for _ in 0..<100_000 {
                let maxVariant = GD.max(
                    arg1: randomValues[0], arg2: randomValues[1], randomValues[2], randomValues[3], randomValues[4], randomValues[5], randomValues[6], randomValues[7], randomValues[8], randomValues[9]
                )
