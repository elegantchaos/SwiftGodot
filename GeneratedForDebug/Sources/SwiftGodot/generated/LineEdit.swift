...
open class LineEdit: Control {
    ...
    /// }
    /// ```
    public var textChanged: GenericSignal<String> { GenericSignal<String> (target: self, signalName: "text_changed") }
    ...
    /// }
    /// ```
    public var textChangeRejected: GenericSignal<String> { GenericSignal<String> (target: self, signalName: "text_change_rejected") }
    ...
    /// }
    /// ```
    public var textSubmitted: GenericSignal<String> { GenericSignal<String> (target: self, signalName: "text_submitted") }
