...
open class Resource: RefCounted {
    ...
    /// }
    /// ```
    public var changed: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "changed") }
    ...
    /// }
    /// ```
    public var setupLocalToSceneRequested: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "setup_local_to_scene_requested") }
