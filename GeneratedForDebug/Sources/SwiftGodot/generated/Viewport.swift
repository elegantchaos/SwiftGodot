...
open class Viewport: Node {
    ...
    /// }
    /// ```
    public var sizeChanged: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "size_changed") }
    ...
    /// }
    /// ```
    public var guiFocusChanged: GenericSignal<Control> { GenericSignal<Control> (target: self, signalName: "gui_focus_changed") }
