...
open class AcceptDialog: Window {
    ...
    /// }
    /// ```
    public var confirmed: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "confirmed") }
    ...
    /// }
    /// ```
    public var canceled: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "canceled") }
    ...
    /// }
    /// ```
    public var customAction: GenericSignal<StringName> { GenericSignal<StringName> (target: self, signalName: "custom_action") }
