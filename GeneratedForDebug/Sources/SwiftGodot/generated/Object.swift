...
open class Object: Wrapped {
    ...
    static var method_emit_signal: GDExtensionMethodBindPtr = {
    ...
    /// }
    /// ```
    public var scriptChanged: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "script_changed") }
    ...
    /// }
    /// ```
    public var propertyListChanged: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "property_list_changed") }
