...
open class Container: Control {
    ...
    /// }
    /// ```
    public var preSortChildren: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "pre_sort_children") }
    ...
    /// }
    /// ```
    public var sortChildren: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "sort_children") }
