...
open class CollisionObject3D: Node3D {
    ...
    /// }
    /// ```
    public var inputEvent: GenericSignal<Node, InputEvent, Vector3, Vector3, Int64> { GenericSignal<Node, InputEvent, Vector3, Vector3, Int64> (target: self, signalName: "input_event") }
