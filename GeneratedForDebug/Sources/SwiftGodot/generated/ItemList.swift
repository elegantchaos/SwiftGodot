...
open class ItemList: Control {
    ...
    /// }
    /// ```
    public var itemSelected: GenericSignal<Int64> { GenericSignal<Int64> (target: self, signalName: "item_selected") }
    ...
    /// }
    /// ```
    public var itemClicked: GenericSignal<Int64, Vector2, Int64> { GenericSignal<Int64, Vector2, Int64> (target: self, signalName: "item_clicked") }
    ...
    /// }
    /// ```
    public var multiSelected: GenericSignal<Int64, Bool> { GenericSignal<Int64, Bool> (target: self, signalName: "multi_selected") }
    ...
    /// }
    /// ```
    public var itemActivated: GenericSignal<Int64> { GenericSignal<Int64> (target: self, signalName: "item_activated") }
