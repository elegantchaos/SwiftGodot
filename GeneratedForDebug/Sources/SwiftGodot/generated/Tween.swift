...
open class Tween: RefCounted {
    ...
    /// }
    /// ```
    public var stepFinished: GenericSignal<Int64> { GenericSignal<Int64> (target: self, signalName: "step_finished") }
    ...
    /// }
    /// ```
    public var loopFinished: GenericSignal<Int64> { GenericSignal<Int64> (target: self, signalName: "loop_finished") }
