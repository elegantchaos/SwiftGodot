...
open class MultiplayerSynchronizer: Node {
    ...
    /// }
    /// ```
    public var synchronized: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "synchronized") }
    ...
    /// }
    /// ```
    public var deltaSynchronized: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "delta_synchronized") }
    ...
    /// }
    /// ```
    public var visibilityChanged: GenericSignal<Int64> { GenericSignal<Int64> (target: self, signalName: "visibility_changed") }
