...
open class VisibleOnScreenNotifier3D: VisualInstance3D {
    ...
    /// }
    /// ```
    public var screenEntered: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "screen_entered") }
    ...
    /// }
    /// ```
    public var screenExited: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "screen_exited") }
