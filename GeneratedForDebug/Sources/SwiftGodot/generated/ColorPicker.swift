...
open class ColorPicker: VBoxContainer {
    ...
    /// }
    /// ```
    public var presetAdded: GenericSignal<Color> { GenericSignal<Color> (target: self, signalName: "preset_added") }
    ...
    /// }
    /// ```
    public var presetRemoved: GenericSignal<Color> { GenericSignal<Color> (target: self, signalName: "preset_removed") }
