...
open class Skeleton3D: Node3D {
    ...
    /// }
    /// ```
    public var poseUpdated: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "pose_updated") }
    ...
    /// }
    /// ```
    public var skeletonUpdated: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "skeleton_updated") }
    ...
    /// }
    /// ```
    public var boneEnabledChanged: GenericSignal<Int64> { GenericSignal<Int64> (target: self, signalName: "bone_enabled_changed") }
    ...
    /// }
    /// ```
    public var boneListChanged: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "bone_list_changed") }
    ...
    /// }
    /// ```
    public var showRestOnlyChanged: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "show_rest_only_changed") }
