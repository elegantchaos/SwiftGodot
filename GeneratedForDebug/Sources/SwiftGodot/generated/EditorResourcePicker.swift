...
open class EditorResourcePicker: HBoxContainer {
    ...
    /// }
    /// ```
    public var resourceSelected: GenericSignal<Resource, Bool> { GenericSignal<Resource, Bool> (target: self, signalName: "resource_selected") }
    ...
    /// }
    /// ```
    public var resourceChanged: GenericSignal<Resource> { GenericSignal<Resource> (target: self, signalName: "resource_changed") }
