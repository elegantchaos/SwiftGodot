...
open class HTTPRequest: Node {
    ...
    /// }
    /// ```
    public var requestCompleted: GenericSignal<Int64, Int64, PackedStringArray, PackedByteArray> { GenericSignal<Int64, Int64, PackedStringArray, PackedByteArray> (target: self, signalName: "request_completed") }
