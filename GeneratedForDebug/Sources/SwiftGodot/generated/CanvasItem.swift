...
open class CanvasItem: Node {
    ...
    /// }
    /// ```
    public var draw: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "draw") }
    ...
    /// }
    /// ```
    public var hidden: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "hidden") }
    ...
    /// }
    /// ```
    public var itemRectChanged: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "item_rect_changed") }
