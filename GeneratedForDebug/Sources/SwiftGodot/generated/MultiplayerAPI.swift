...
open class MultiplayerAPI: RefCounted {
    ...
    /// }
    /// ```
    public var peerConnected: GenericSignal<Int64> { GenericSignal<Int64> (target: self, signalName: "peer_connected") }
    ...
    /// }
    /// ```
    public var peerDisconnected: GenericSignal<Int64> { GenericSignal<Int64> (target: self, signalName: "peer_disconnected") }
    ...
    /// }
    /// ```
    public var connectedToServer: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "connected_to_server") }
    ...
    /// }
    /// ```
    public var connectionFailed: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "connection_failed") }
    ...
    /// }
    /// ```
    public var serverDisconnected: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "server_disconnected") }
