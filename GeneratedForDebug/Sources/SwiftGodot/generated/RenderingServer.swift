...
open class RenderingServer: Object {
    ...
    /// }
    /// ```
    public var framePreDraw: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "frame_pre_draw") }
    ...
    /// }
    /// ```
    public var framePostDraw: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "frame_post_draw") }
