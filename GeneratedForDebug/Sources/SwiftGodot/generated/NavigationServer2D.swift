...
open class NavigationServer2D: Object {
    ...
    /// 
    public static func mapGetRandomPoint(map: RID, navigationLayers: UInt32, uniformly: Bool) -> Vector2 {
        var _result: Vector2 = Vector2 ()
        withUnsafePointer(to: map.content) { pArg0 in
    ...
    public static func regionGetTransform(region: RID) -> Transform2D {
    ...
    /// 
    public static func regionGetRandomPoint(region: RID, navigationLayers: UInt32, uniformly: Bool) -> Vector2 {
        var _result: Vector2 = Vector2 ()
        withUnsafePointer(to: region.content) { pArg0 in
            withUnsafePointer(to: navigationLayers) { pArg1 in
                withUnsafePointer(to: uniformly) { pArg2 in
    ...
    public static func agentGetVelocity(agent: RID) -> Vector2 {
        var _result: Vector2 = Vector2 ()
        withUnsafePointer(to: agent.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
    ...
    public static func agentGetPosition(agent: RID) -> Vector2 {
        var _result: Vector2 = Vector2 ()
        withUnsafePointer(to: agent.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
    ...
    public static func obstacleGetVelocity(obstacle: RID) -> Vector2 {
        var _result: Vector2 = Vector2 ()
        withUnsafePointer(to: obstacle.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
    ...
    public static func obstacleGetPosition(obstacle: RID) -> Vector2 {
        var _result: Vector2 = Vector2 ()
        withUnsafePointer(to: obstacle.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
    ...
    public static func obstacleGetVertices(obstacle: RID) -> PackedVector2Array {
        let _result: PackedVector2Array = PackedVector2Array ()
        withUnsafePointer(to: obstacle.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
    ...
    public static func isBakingNavigationPolygon(_ navigationPolygon: NavigationPolygon?) -> Bool {
        var _result: Bool = false
        withUnsafePointer(to: navigationPolygon?.handle) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
    ...
    /// 
    public static func simplifyPath(_ path: PackedVector2Array, epsilon: Double) -> PackedVector2Array {
        let _result: PackedVector2Array = PackedVector2Array ()
    ...
    /// }
    /// ```
    public var mapChanged: GenericSignal<RID> { GenericSignal<RID> (target: self, signalName: "map_changed") }
    ...
    /// }
    /// ```
    public var navigationDebugChanged: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "navigation_debug_changed") }
