...
open class EditorSpinSlider: Range {
    ...
    /// }
    /// ```
    public var grabbed: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "grabbed") }
    ...
    /// }
    /// ```
    public var ungrabbed: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "ungrabbed") }
    ...
    /// }
    /// ```
    public var valueFocusEntered: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "value_focus_entered") }
    ...
    /// }
    /// ```
    public var valueFocusExited: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "value_focus_exited") }
