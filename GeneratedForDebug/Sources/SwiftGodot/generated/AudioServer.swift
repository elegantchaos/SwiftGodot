...
open class AudioServer: Object {
    ...
    /// }
    /// ```
    public var busLayoutChanged: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "bus_layout_changed") }
    ...
    /// }
    /// ```
    public var busRenamed: GenericSignal<Int64, StringName, StringName> { GenericSignal<Int64, StringName, StringName> (target: self, signalName: "bus_renamed") }
