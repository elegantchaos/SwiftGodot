...
open class Control: CanvasItem {
    ...
    /// }
    /// ```
    public var resized: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "resized") }
    ...
    /// }
    /// ```
    public var guiInput: GenericSignal<InputEvent> { GenericSignal<InputEvent> (target: self, signalName: "gui_input") }
    ...
    /// }
    /// ```
    public var sizeFlagsChanged: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "size_flags_changed") }
    ...
    /// }
    /// ```
    public var minimumSizeChanged: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "minimum_size_changed") }
