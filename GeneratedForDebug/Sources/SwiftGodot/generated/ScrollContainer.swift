...
open class ScrollContainer: Container {
    ...
    /// }
    /// ```
    public var scrollStarted: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "scroll_started") }
    ...
    /// }
    /// ```
    public var scrollEnded: GenericSignal< /* no args */ > { GenericSignal< /* no args */ > (target: self, signalName: "scroll_ended") }
